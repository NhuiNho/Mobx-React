...
const CardLineTodo: React.FC<CardLineTodoProps> = ({ todo, colorText }) => {
          ...
          <div className="card__line_todoapp">
               <div className={`card__content_todoapp ${colorText}`}>
                    ...
                    <div className="icon__container_todoapp">
                         ...
                         <button type="button" className="button__done_todoapp" onClick={() => handleDelete1()}>
                              <span>
                                   <svg width="31" height="30" viewBox="0 0 31 30" fill="none"
