...
import "./iconEditDeleteTodo.css";

interface IconEditDeleteTodoProps {
     colorIcon: string;
     handleDone: (isShow: boolean) => void;
     handleDelete: () => void;
}

const IconEditDeleteTodo: React.FC<IconEditDeleteTodoProps> = observer(({ colorIcon, handleDone, handleDelete }) => {
     const onToggleCompleted = () => {
          ...
          if (confirm) {
               ...
               handleDone(true); // Gọi hàm callback handleDone để thông báo rằng todo đã được cập nhật
          }
     }
     ...
     return (
          <div className="icon-container">
               <button type="button" className="buttonDone" onClick={() => onToggleCompleted()}>
                    <span>
                         <svg width="31" height="30" viewBox="0 0 31 30" fill="none"
                              xmlns="http://www.w3.org/2000/svg" className="icon">
                              <rect x="0.0487213" width="30" height="30" rx="5" fill="#15101C" />
...
export default IconEditDeleteTodo